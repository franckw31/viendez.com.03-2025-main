...
$fin=$_POST['fin'];
$ante=$_POST['ante'];
$sql=mysqli_query($con,"UPDATE `blindes-live` SET `sb` = '$sb',`bb` = '$bb',`id-activite` = '$id_activite', `ante` = '$ante', `duree` = '$duree', `ordre` = '$ordre', `fin` = '$fin' WHERE `id` = '$id';");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Gestion Des blindes live</h1>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
												...
												<div class="panel-body">
													...
													<form role="form" name="dcotorspcl" method="post" >
														<div class="form-group">
                                                            ...
                                                            <?php 
                                                            $id=intval($_GET['id']);
	                                                        $sql=mysqli_query($con,"SELECT * FROM `blindes-live` WHERE `id` = '$id'");
                                                            ...
                                                            {														
		                                                        ...
		                                                        <input type="text" name="sb" class="form-control" value="<?php echo $row['sb'];?>" >
																<input type="text" name="bb" class="form-control" value="<?php echo $row['bb'];?>" >
		                                                        <input type="int" name="duree" class="form-control" value="<?php echo $row['duree'];?>" >
