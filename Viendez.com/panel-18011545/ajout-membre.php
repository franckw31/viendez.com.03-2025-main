...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "insert into joueurs(prenom,fname,lname,contactno,email,password) values('$joueurprenom','$joueurfname','$joueurlname','$joueurcontactno','$joueuremail','$joueurpassword')");
                                                ...
                                                <div class="panel-body">
                                                    <form role="form" name="adddoc" method="post"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="joueurfname" class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="joueurlname" class="form-control"
                                                                placeholder="Prenom" required="true">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="joueurprenom">
                                                                Pseudo
                                                            </label>
                                                            <input type="text" name="joueurprenom" class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="joueurpassword" class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="joueurcontactno" class="form-control"
                                                                placeholder="Numero Contact" required="true">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="fess">
                                                                Email
                                                            </label>
                                                            <input type="email" id="joueuremail" name="joueuremail"
