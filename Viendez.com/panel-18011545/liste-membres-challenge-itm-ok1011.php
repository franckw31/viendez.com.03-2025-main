                                                ...
                                                <div id="layoutSidenav_content">
                                                    <main>
                                                        <div class="container-fluid px-4">
                                                            <h1 class="mt-4">Classement des Challenges Au <span class="current-date"><?php 
$monthNames = [
    1 => 'Janvier',
    2 => 'Février',
    3 => 'Mars',
...
<ol class="breadcrumb mb-4">
    ...
    <li class="breadcrumb-item active">Classement des membres Au <span class="current-date"><?php 
$monthNames = [
    1 => 'Janvier',
    2 => 'Février',
    3 => 'Mars',
