<?php
	...
	if (strlen($_SESSION['id'] == 0)) {
		...
		if (isset($_POST['submit'])) {
			...
			$recave_montant = floatval($_POST['recave_montant']);
			$recave_jetons = intval($_POST['recave_jetons']);
...
+																						<input class="form-control" id="recave" name="recave" type="number" step="1" style="width:80px;" value="<?php echo isset($row['recave']) ? intval($row['recave']) : 0; ?>">
+																						<input class="form-control" id="recave_montant" name="recave_montant" type="number" step="0.01" style="width:120px;" placeholder="Montant (€)" value="<?php echo isset($row['recave_montant']) ? htmlspecialchars($row['recave_montant']) : ''; ?>">
+																						<input class="form-control" id="recave_jetons" name="recave_jetons" type="number" step="1" style="width:100px;" placeholder="Jetons" value="<?php echo isset($row['recave_jetons']) ? intval($row['recave_jetons']) : ''; ?>">
+																					</div>
+																				</td>
