...
$sql=mysqli_query($con,"insert into blindes(nom) values('$doctorspecilization')");
...
$choix=$_GET['del'];
//$sql=mysqli_query($con,"delete * from 'loisirs-individu' where id = '$sid'");
mysqli_query($con,"DELETE FROM `blindes` WHERE `blindes`.`id-blinde` = '$sid'");
//$_SESSION['msg']="data deleted !!";


$_SESSION['msg']=$choix;
 header('location:/panel/ajout-blindes.php');exit;
}
?>
<!DOCTYPE html>
<html lang="en">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">blindes</h5>
												</div>
												<div class="panel-body">
													...
													<form role="form" name="dcotorspcl" method="post" >
														<div class="form-group">
															...
															<input type="text" name="doctorspecilization" class="form-control"  placeholder="Ajouter la nouvelle blinde ici">
														</div>														
																						...
																						<tbody>
																							...
																							{?>
																								<tr>
																									...
																									<td>                                     
																										<a href="edit-blindes.php?id=<?php echo $row['id-blinde'];?>"> 
																										<i class="fas fa-edit"></i></a>
																										<a href="ajout-blindes.php?id=<?php echo $row['id-blinde']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>												
																									</td>
																								</tr>
																							<?php $cnt=$cnt+1; }?>                                      
																						</tbody>
