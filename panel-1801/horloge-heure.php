...
function primeAudioOnce() {
    ...
    if (typeof responsiveVoice !== 'undefined') {
        try {
            responsiveVoice.speak(fallbackText, 'French Male');
            return;
        } catch (e) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function playAlert(customText) {
        ...
        if (typeof responsiveVoice !== 'undefined') {
            ...
            if (foundMale) voice = "French Female";
        ...
        try {
            ...
            if (
                ...
                if (nowTs - lastElimAnnouncementTime > 1000) {
                    ...
                    if (typeof responsiveVoice !== 'undefined') {
                        responsiveVoice.speak(elimMsg, 'French Male');
                    } else if ('speechSynthesis' in window) {
                        const msg = new SpeechSynthesisUtterance(elimMsg);
                        msg.lang = 'fr-FR';
                        msg.rate = 0.95;
                        window.speechSynthesis.speak(msg);
                    }
            ...
            if (
                ...
                if (typeof responsiveVoice !== 'undefined') {
                    responsiveVoice.speak(recaveMsg, 'French Male');
                } else if ('speechSynthesis' in window) {
                    const msg = new SpeechSynthesisUtterance(recaveMsg);
                    msg.lang = 'fr-FR';
                    msg.rate = 0.95;
                    window.speechSynthesis.speak(msg);
                }
