				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Recherche loisirs </h1>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
																		...
																		<!--    <div class="card-header">
																				...
																				<div class="card-body">
																					<table id="datatablesSimple">
																						...
																						<tbody>
																							<?php $ret=mysqli_query($con,"select * from loisirs");
																							$cnt=1;
																							...
																							{?>
																								<tr>
																									...
																									<td>
																										<a href="individu-loisirs.php?id=<?php echo $row['id'];?>"> 
