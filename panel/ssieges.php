...
echo "--".$activi."--";
                while ($row = mysqli_fetch_array($ret)) 
                    { 
                        ...
                        $nb_tables = $row["nb-tables"]; echo "/--".$activi."--/";
                    };   
echo "*".$nb_tables."*";					
                // $nb_tables=2;
                $latable = "";               
...
echo "fin";
        ...
        <script type="text/javascript">window.location.replace("http://viendez.com/panel/voir-activite.php?uid=<?php echo $id_activite; ?>");</script> ;