        ...
        <form method="post">
            <table class="simple-form-table">
                <tr>
                    ...
                    <td>
                        <input class="form-control" type="number" id="nb_joueurs_payes" name="nb_joueurs_payes" value="<?php echo isset($_POST['nb_joueurs_payes']) ? htmlspecialchars($_POST['nb_joueurs_payes']) : round($total_participants * 0.2); ?>" min="1" max="<?php echo $total_participants; ?>">
                    </td>
                </tr>
                <tr>
                    <th></th>
                ...
                if (!empty($distributions)) {
                    ...
                    if (abs($total_distribution - 1) > 0.001) {
                        ...
                        for ($i = 0; $i < count($distributions); $i++) {
                            ...
                            $gain_estime = $price_pool_display * $distributions[$i];
                            echo "<tr><td>" . ($i + 1) . "</td><td>" . number_format($pourcentage, 2) . "%</td><td>" . number_format($gain_estime, 2) . "</td></tr>";
                        }
                        echo "</tbody>";
                        echo "</table>";
                    }
